...
const JobCard = ({ job }) => {
  ...
  return (
    <div className="rounded-xl border border-base-300 p-4 bg-base-100 hover:border-blue-500 hover:shadow-sm hover:scale-102 hover:-translate-y-3 transition-all duration-500 space-y-4">
      <div
       
        className="flex flex-col items-start justify-center gap-4 min-h-full "
      >
        {/* Header */}
